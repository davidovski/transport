 ...
 *
 * you can change type of noise between grad & value noise by commenting/uncommenting block you can change type of interpolation between bicubic/bilinear by commenting/uncommenting block
 */
public class FastNoise {
    public static int noise(double x, double y, int nbOctave) {
        ...
        while (octave != 0) {
            ...
            /*
             * NOTE : on for true grandiant noise uncomment following block for true gradiant we need to perform scalar product here, gradiant vector are created/deducted using the above pseudo random
             * values (alt1...alt4) : by cutting thoses values in twice values to get for each a fixed x,y vector gradX1= alt1&0xFF gradY1= (alt1&0xFF00)>>8
             *
